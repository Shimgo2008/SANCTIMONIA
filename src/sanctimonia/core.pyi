...
@overload
def solve_cg_ilu(A: scipy.sparse.csc_matrix["std::__1::complex<double>"], b: Annotated[NDArray[numpy.complex128], dict(shape=(None,), writable=False)], x0: Annotated[NDArray[numpy.complex128], dict(shape=(None,), order='C')] | None = None, tol: float = 1e-06) -> Annotated[NDArray[numpy.complex128], dict(shape=(None,), order='C')]: ...
...
@overload
def solve_bicgstab_ilu(A: scipy.sparse.csc_matrix["std::__1::complex<double>"], b: Annotated[NDArray[numpy.complex128], dict(shape=(None,), writable=False)], x0: Annotated[NDArray[numpy.complex128], dict(shape=(None,), order='C')] | None = None, tol: float = 1e-06) -> Annotated[NDArray[numpy.complex128], dict(shape=(None,), order='C')]: ...
...
@overload
def solve_lscg_ilu(A: scipy.sparse.csc_matrix["std::__1::complex<double>"], b: Annotated[NDArray[numpy.complex128], dict(shape=(None,), writable=False)], x0: Annotated[NDArray[numpy.complex128], dict(shape=(None,), order='C')] | None = None, tol: float = 1e-06) -> Annotated[NDArray[numpy.complex128], dict(shape=(None,), order='C')]: ...
...
class NNPreprocessor:
    ...
    def predict(self, A: scipy.sparse.csc_matrix["std::__1::complex<double>"], b: Annotated[NDArray[numpy.complex128], dict(shape=(None,), order='C')]) -> Annotated[NDArray[numpy.complex128], dict(shape=(None,), order='C')]: ...
